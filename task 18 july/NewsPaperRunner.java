...
boolean value5=ref.createNewsPaper("Kannada Prabha",29,"Kannada");
 System.out.println(value3);
 ref.displayInfo();

boolean value6=ref.createNewsPaper("Kannada Prabha",29,"Kannada");
 System.out.println(value3);
 ref.displayInfo();

boolean value=ref.createNewsPaper("Kannada Prabha",29,"Kannada");
 System.out.println(value3);
 ref.displayInfo();

boolean value8=ref.createNewsPaper("Kannada Prabha",29,"Kannada");
 System.out.println(value3);
 ref.displayInfo();

boolean value9=ref.createNewsPaper("Kannada Prabha",29,"Kannada");
 System.out.println(value3);
 ref.displayInfo();
